...
function Footer() {
  return (
    <footer
      className="bg-black text-white py-3 px-6 rounded-t-3xl"
      id="contactUs"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-4 p-1">
        {/* DevShastra */}
        ...
        <div className="w-full col-span-1 justify-center ml-10">

...
return (
  <div className={cn("flex items-center justify-center p-8", className)}>
    <div
      className="relative grid grid-cols-[1fr_1fr] grid-rows-[auto_auto_auto] gap-x-12 gap-y-4 w-full"
    ...
    >
      ...
      <div className="col-start-2 row-start-2 flex flex-col justify-center min-h-[160px]">
        <AnimatePresence mode="wait">
          ...
          >
            <h3 className="text-2xl font-bold dark:text-white">{activeItem.title}</h3>
            <p className="text-base text-neutral-600 dark:text-neutral-400 mt-3">{activeItem.description}</p>
          </motion.div>
        </AnimatePresence>
      </div>
